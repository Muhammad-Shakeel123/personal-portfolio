...
function Notification({ id, type, title, message, onDismiss }) {
  ...
  const typeMetadata =
    Notification.Types[displayingData.type] || Notification.Types['default'];
  ...
  return (
    <div
      className={`notification notification-${transitionStatus} ${typeMetadata.class}`}
    >
      <div className={`notification-header`}>
        <div className={`notification-title text-4`}>
          <i
            className={`${typeMetadata.faIcon} ${typeMetadata.faIconClass} me-2`}
          />
        ...
        <button
          className={`notification-close-button btn btn-link-default-inv text-4`}
          onClick={onDismiss}
        >
      ...
      <div
        className={`notification-body text-3`}
...
Notification.Types = {
  default: {
    ...
    faIconClass: 'text-normal',
  },
  error: {
    class: 'notification-error',
    faIcon: 'fa-solid fa-warning',
    faIconClass: 'text-normal',
  },
};
