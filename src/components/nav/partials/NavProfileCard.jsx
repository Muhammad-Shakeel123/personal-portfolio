...
function NavProfileCard({ profile, expanded }) {
  ...
  const namePronunciationIpa = language.getTranslation(
    profile.locales,
    'name_pronunciation_ipa',
    null,
  );
  const namePronunciationAudioUrl = language.getTranslation(
    profile.locales,
    'name_pronunciation_audio_url',
    null,
  );
  const namePronunciationButtonVisible =
    namePronunciationIpa || namePronunciationAudioUrl;
